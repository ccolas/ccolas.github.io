 ...
 */
export var normaliseDegrees=function(degrees){
    degrees=degrees % 360;
    if(degrees<0) {
        degrees+=360;
    }
 ...
 */
export var normaliseRadians=function(radians){
 ...
 */
export var degrees=function(radians) {
 ...
 */
export var radians=function(degrees) {
