var jsPsychHtmlMultSliderResponse = (function (jspsych) {
  ...
  class HtmlSliderResponsePlugin {
      ...
      trial(display_element, trial) {
          ...
          html += '<div id="jspsych-html-mult-slider-response-stimulus">' + trial.stimulus + "</div>";
          if (trial.prompt !== null) {
            html += trial.prompt[0];
          }
          html +=
              '<div class="jspsych-html-mult-slider-response-container" style="position:relative; margin: 0 auto 3em auto; ';
          ...
          html +=
              '<input type="range" class="jspsych-slider" value="' +
                  ...
                  '" step="' +
                  trial.step +
                  '" id="jspsych-html-mult-slider-response-response"></input>';
          html += "<div>";
        ...
        html += "</div>";
          ...
          if (trial.require_movement) {
              ...
              display_element
                  .querySelector("#jspsych-html-mult-slider-response-response")
          ...
          display_element
              ...
              response.response = display_element.querySelector("#jspsych-html-mult-slider-response-response").valueAsNumber;
