...
export function GridPhysics() {}

GridPhysics.prototype = {
	passiveMovement: function (sprite) {
		if (sprite.speed == null) var speed = 1;
		else var speed = sprite.speed;
	...
	distance: function (r1, r2) {
		return (
			Math.sqrt(Math.pow(r1.top - r2.top, 2)) +
			Math.sqrt(Math.pow(r1.left - r2.left, 2))
		);
	},
	// distance : function (r1, r2) {
