 ...
 * @type Boolean
 */
//export var inWorker = (global.importScripts !== undefined);
export var inWorker = (typeof importScripts !== 'undefined');

/**
 * executed in scope of worker
 * @ignore
 */
export var _ready = function() {
 ...
 * @ignore
 **/
export var _logMessage = function() {
   var args = [];
 ...
 */
export var Worker = function(moduleId) {
