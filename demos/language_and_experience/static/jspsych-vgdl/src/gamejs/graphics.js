 ...
 */
export var line = function(surface, color, startPos, endPos, width) {
 ...
 */
export var circle = function(surface, color, pos, radius, width) {
   if (isNaN(radius)) {
 ...
 */
export var arc= function(surface, color, pos, startAngle, stopAngle, radius, width) {
   var ctx = surface.context;
   ctx.save();
   ctx.beginPath();
   ctx.strokeStyle = ctx.fillStyle = color;
 ...
 */
export var quadraticCurve = function(surface, color, startPos, endPos, controlPos, width) {
 ...
 */
export var bezierCurve = function(surface, color, startPos, endPos, ct1Pos, ct2Pos, width) {
   if (!startPos || !(startPos instanceof Array)) {
 ...
 */
export var blitArray = function(surface, surfaceArray) {
 ...
 */
export var SurfaceArray = function(surfaceOrDimensions) {
   var size = null;
   var data = null;
   var imageData = null;
