 ...
 */
export var setNumChannels = function(count) {
   NUM_CHANNELS = parseInt(count, 10) || NUM_CHANNELS;
};

export var getNumChannels = function() {
   return NUM_CHANNELS;
};
 ...
 * @ignore
 */
export var preload = function(audioUrls, showProgressOrImage) {
   var countTotal = 0;
   var countLoaded = 0;
 ...
 * @ignore
 */
export var isPreloading = function() {
   return _PRELOADING;
};
 ...
 *                of the sound
 */
export var Sound = function(uriOrAudio) {
   var cachedAudio;
