 ...
 */
export var translate = function(m1, dx, dy) {
 ...
 */
export var rotate = function(m1, angle) {
   // radians
 ...
 */
export var rotation = function(m1) {
 ...
 */
export var scale = function(m1, svec) {
   var sx = svec[0];
   var sy = svec[1];
