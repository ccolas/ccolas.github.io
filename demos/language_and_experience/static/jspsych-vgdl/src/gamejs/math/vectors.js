 ...
 */
export var multiply = function(a, s) {
   if (typeof s === 'number') {
      return [a[0] * s, a[1] * s];
   }
 ...
 * @param {Number} s
 */
export var divide = function(a, s) {
   if (typeof s === 'number') {
      return [a[0] / s, a[1] / s];
   }
 ...
 */
export var rotate=function(v, angle){
 ...
 */
export var angle=function(v1, v2){
 ...
 */
export var truncate = function(v, maxLength) {
   if (len(v) > maxLength) {
